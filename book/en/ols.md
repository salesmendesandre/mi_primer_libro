...
The **Ordinary Least Squares** (OLS) method is a mathematical optimization technique used to find the line (or hyperplane) that best fits a set of data.
...
```{raw} latex
\begin{center}
\textbf{Interactive visualization:} Please refer to the HTML version of the book to access the Ordinary Least Squares (OLS) interactive tool.
\end{center}
```
